"""
Django settings for sweetbook_project project.
...
SECRET_KEY = 'i+l0)(e_71g(0v4tgn8v#snug0v#wob!ks$lmqvacqn6+vi0bp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'sweetbook.pythonanywhere.com',
    '127.0.0.1',
]
...
ROOT_URLCONF = 'sweetbook_project.urls'
...
WSGI_APPLICATION = 'sweetbook_project.wsgi.application'
